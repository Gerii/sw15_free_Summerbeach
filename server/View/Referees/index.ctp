<div class="teamnames index">
	...
	<tr>
		...
		<td><?php echo h($referee['Referee']['username']); ?>&nbsp;</td>
		<td><?php echo h($referee['Referee']['password']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $referee['Referee']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $referee['Referee']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
