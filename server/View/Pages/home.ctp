...
echo $this->Form->button('A Button', array('class' => 'btn btn-primary icon-search icon-white' ,'onclick' => "location.href='/map/stops/name/glon'+document.getElementById('gllon').value+'/lon'+document.getElementById('long').value+'/glat'+document.getElementById('gllat').value+'/lat'+document.getElementById('lat').value+'/name'+document.getElementById('name').value;"));




echo $this->Form->input('link', array('label' => false, "class" => " form-control input-medium", "placeholder" => __('search for name'), 'id' => 'name1'));
echo $this->Form->input('link', array('label' => false, "class" => " form-control input-medium", "placeholder" => __('search for name'), 'id' => 'name2'));
echo $this->Form->button('A Button', array('class' => 'btn btn-primary icon-search icon-white' ,'onclick' => "location.href='/map/lines/find/'+document.getElementById('name1').value+'/'+document.getElementById('name2').value;"));
?>
<?php
/**
